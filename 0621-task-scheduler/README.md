<h2><a href="https://leetcode.com/problems/task-scheduler/?envType=list&envId=r0owyfj3">621. Task Scheduler</a></h2><h3>Medium</h3><hr><p>Given a characters array <code>tasks</code>, representing the tasks a CPU needs to do, where each letter represents a different task. Tasks could be done in any order. Each task is done in one unit of time. For each unit of time, the CPU could complete either one task or just be idle.</p>
